...
export type Mutation = {
  ...
  updateCurrentUserInfo?: Maybe<UpdateCurrentUserInfoPayload>;
...
export type MutationUpdateCurrentUserInfoArgs = {
  input: UpdateCurrentUserInfoInput;
};
...
/** Autogenerated input type of UpdateCurrentUserInfo */
export type UpdateCurrentUserInfoInput = {
  name: Scalars['String'];
...
/** Autogenerated return type of UpdateCurrentUserInfo */
export type UpdateCurrentUserInfoPayload = {
  __typename?: 'UpdateCurrentUserInfoPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
...
export type UpdateCurrentUserInfoMutation = (
  { __typename?: 'Mutation' }
  & { updateCurrentUserInfo?: Maybe<(
    { __typename?: 'UpdateCurrentUserInfoPayload' }
    & Pick<UpdateCurrentUserInfoPayload, 'success' | 'errors'>
  )> }
);
...
export const UserUpdatePasswordDocument = gql`
  ...
  userUpdatePassword(password: $password, passwordConfirmation: $passwordConfirmation) {
    authenticatable {
      id
    }
  }
...
export const UpdateCurrentUserInfoDocument = gql`
    mutation UpdateCurrentUserInfo($input: UpdateCurrentUserInfoInput!) {
  updateCurrentUserInfo(input: $input) {
    ...
    `;
export type UpdateCurrentUserInfoMutationFn = Apollo.MutationFunction<UpdateCurrentUserInfoMutation, UpdateCurrentUserInfoMutationVariables>;
 ...
 * });
 */
export function useUpdateCurrentUserInfoMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCurrentUserInfoMutation, UpdateCurrentUserInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCurrentUserInfoMutation, UpdateCurrentUserInfoMutationVariables>(UpdateCurrentUserInfoDocument, options);
      }
...
export type UpdateCurrentUserInfoMutationOptions = Apollo.BaseMutationOptions<UpdateCurrentUserInfoMutation, UpdateCurrentUserInfoMutationVariables>;